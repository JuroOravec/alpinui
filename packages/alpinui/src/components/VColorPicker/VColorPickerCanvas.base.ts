...
import { clamp, convertToUnit, getEventCoordinates, normalizeClass } from '@/util/helpers';
...
export interface VColorPickerCanvasSlots {
  /** Empty */
}

export const _ColorPickerCanvas = defineComponent({
  ...
  slots: makeSlots<VColorPickerCanvasSlots>(null),

  setupHeadless(props, vm) {
    const { computed, onMounted, ref, shallowRef, watch } = vm.reactivity;
    ...
    const canvasClasses = computed(() => normalizeClass([
