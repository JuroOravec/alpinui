...
import { acceleratedEasing, deceleratedEasing, standardEasing } from '@/util/easing';
...
export const VDialogTransition = genericVueComponent()(defineComponent({
  name: 'VDialogTransition',

  props: makeVDialogTransitionProps(),

  slots: makeSlots<VDialogTransitionSlots>({
    default: null,
  }),
  ...
  renderHeadless: (vm, { functions }, { slots, props }) => {
    return props.target
      ? (
        <Transition
