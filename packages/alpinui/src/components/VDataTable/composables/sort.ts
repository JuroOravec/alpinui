...
export function createSort(vm: HeadlessInstance, props: SortProps) {
  const { toRef } = vm.reactivity;
...
export function useSort(vm: HeadlessInstance) {
