...
// Utilities
import { clamp, createRange, getDecimals } from '@/util/helpers';
...
export const useSteps = (vm: HeadlessInstance, props: SliderProps) => {
...
export const useSlider = (
  ...
  const { computed, provide, ref, shallowRef, toRef } = vm.reactivity;
