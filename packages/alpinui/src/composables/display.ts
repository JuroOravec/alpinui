// Utilities
import { computed, reactive, shallowRef, toRefs, watchEffect } from 'alpine-reactivity';
...
import type { ComputedRef, UnwrapRef } from 'alpine-reactivity';
import type { InjectionKey, PropType } from 'vue';

type UnwrapKeys <T extends object> = {
...
export interface DisplayInstance {
  ...
  name: ComputedRef<DisplayBreakpoint>;
  height: ComputedRef<number>;
  width: ComputedRef<number>;
  mobile: ComputedRef<boolean>;
  mobileBreakpoint: ComputedRef<number | DisplayBreakpoint>;
  platform: ComputedRef<DisplayPlatform>;
  thresholds: ComputedRef<DisplayThresholds>;
...
export const DisplaySymbol: InjectionKey<DisplayInstance> = Symbol.for('alpinui:display');
...
export function createDisplay(options?: DisplayOptions, ssr?: SSROptions): DisplayInstance {
  ...
  const state = reactive({} as UnwrapKeys<DisplayInstance>);
