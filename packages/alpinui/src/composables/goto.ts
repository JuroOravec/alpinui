...
import { clamp, mergeDeep, refElement } from '@/util/helpers';
...
export interface InternalGoToOptions {
  container: AlpineInstance<Data, Data, EmitsOptions> | HTMLElement | string;
  duration: number;
  layout: boolean;
  offset: number;
...
export const GoToSymbol: InjectionKey<GoToInstance> = Symbol.for('alpinui:goto');
...
function getContainer(el?: AlpineInstance<Data, Data, EmitsOptions> | HTMLElement | string) {
  return getTarget(el) ?? (document.scrollingElement || document.body) as HTMLElement;
}

function getTarget(el: AlpineInstance<Data, Data, EmitsOptions> | HTMLElement | string | undefined) {
...
export async function scrollTo(
  _target: AlpineInstance<Data, Data, EmitsOptions> | HTMLElement | number | string,
...
export function useGoTo(vm: AlpineInstance<Data, Data, EmitsOptions>, _options: GoToOptions = {}) {
  ...
  async function go(
    target: AlpineInstance<Data, Data, EmitsOptions> | HTMLElement | string | number,
