...
export const GoToSymbol: InjectionKey<GoToInstance> =
  Symbol.for('vuetify:goto');
...
export async function scrollTo(
  ...
  if (typeof target === 'number') {
    ...
    targetLocation =
      getOffset(target, horizontal, rtl) -
      getOffset(container, horizontal, rtl);
...
export function useGoTo(vm: HeadlessInstance, _options: GoToOptions = {}) {
