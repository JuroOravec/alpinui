...
// Utilities
import { computed, unref } from 'alpine-reactivity';
...
import type { InjectionKey, JSXComponent } from 'vue';
import type { IconValue } from '@/components/VIcon/icons';

export { IconValue } from '@/components/VIcon/icons';
...
export const IconSymbol: InjectionKey<InternalIconOptions> = Symbol.for('alpinui:icons');
...
export const useIcon = (vm: AlpineInstance<Data>, props: Ref<IconValue | undefined>) => {
  const icons = vm.$inject(IconSymbol);

  if (!icons) throw new Error('Missing Alpinui Icons provide!');
