...
// Utilities
import { reactive, watch } from 'alpine-reactivity';
...
// Adapters
import { AlpinuiDateAdapter } from './adapters/alpinui';
...
export function useDate(vm: AlpineInstance<Data, Data, EmitsOptions>): DateInstance {
