...
function createProvideFunction(
  ...
  return (vm: HeadlessInstance, props: LocaleOptions): LocaleInstance => {
...
export function createVuetifyAdapter(vm: HeadlessInstance, options?: LocaleOptions): LocaleInstance {
  const { ref, shallowRef } = vm.reactivity;
