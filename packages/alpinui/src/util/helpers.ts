// TODO
// TODO
// TODO - Remove dependency on vue
// TODO
// TODO

// Utilities
import { computed, reactive, readonly, shallowRef, toRefs, unref, watchEffect } from 'alpine-reactivity';
import { Comment, Fragment, isVNode } from 'vue';
import { IN_BROWSER } from '@/util/globals';

// Types
import type { AlpineInstance, Data, EmitsOptions } from 'alpine-composition';
import type { Ref, ToRefs } from 'alpine-reactivity';
import type {
...
export function refElement(obj?: AlpineInstance<Data, Data, EmitsOptions> | HTMLElement | null): HTMLElement | undefined {
  if (obj && '$el' in obj) {
...
export type TemplateRef = {
  (target: Element | AlpineInstance<Data, Data, EmitsOptions> | null): void;
  value: HTMLElement | AlpineInstance<Data, Data, EmitsOptions> | null | undefined;
  readonly el: HTMLElement | undefined;
}
export function templateRef() {
  const el = shallowRef<HTMLElement | AlpineInstance<Data, Data, EmitsOptions> | null>();
  const fn = (target: HTMLElement | AlpineInstance<Data, Data, EmitsOptions> | null) => {
    el.value = target;
  };
