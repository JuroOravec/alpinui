...
export default [
      ...
      }),
      {
        async buildEnd () {
          ...
          { // Components
            ...
            // NOTE: Directives not applicable for Alpinui
            //
          { // Directives
  ...
  //           ])
  //         }).then(result => {
  //           writeFile(fileURLToPath(new URL('../dist/alpinui-labs.css', import.meta.url)), banner + result[0].css, 'utf8')
  //           writeFile(fileURLToPath(new URL('../dist/alpinui-labs.min.css', import.meta.url)), banner + result[1].css, 'utf8')
  //         })
